...
screen navigation():
    ...
    vbox:
        ...
        if renpy.get_screen("main_menu"):
            ...
            textbutton _("Mulai") action Start() hover_background "button_hover.png"
        ...
        if renpy.get_screen("main_menu"):
            textbutton _("Muat") action ShowMenu("load") hover_background "button_hover.png"

            textbutton _("Pengaturan") action ShowMenu("preferences") hover_background "button_hover.png"

            if _in_replay:

                textbutton _("Akhiri Replay") action EndReplay(confirm=True) hover_background "button_hover.png"
            ...
            if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
                ...
                textbutton _("Bantuan") action ShowMenu("help") hover_background "button_hover.png"
            ...
            if renpy.variant("pc"):
                ...
                textbutton _("Keluar"):
                    ...
                    text_color "#EC6C35"
                    text_outlines [(absolute(3), '#FDE9D5', absolute(0), absolute(0))]
...
style navigation_button:
    ...
    hover_background "button_hover2.png"
    
style navigation_button_text:
    properties gui.text_properties("navigation_button")
    xalign 0.5
    outlines [(absolute(3), '#E78344', absolute(0), absolute(0))]
    #hover_outlines [(absolute(3), '#FDE9D5', absolute(0), absolute(0))]
...
style confirm_button:
    ...
    hover_background "confirm_hover.png"
...
screen result:
    ...
    vbox:
        ...
        text "{color=#E78344}[player_name]{/color} adalah seorang {color=#E78344}[personality_type]{/color}"
    vbox:
        style_prefix "result"
        textbutton "":
            action Return()
